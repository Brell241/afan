  ...
  plugins: [
    magicLink({
      sendMagicLink: async ({ email, url }) => {
        ...
        const finalUrl = url.replace(/^https?:\/\/[^/]+/, baseUrl);
        await resend.emails.send({
          ...
          html: `
            <div style="font-family:sans-serif;max-width:480px;margin:0 auto;padding:32px 24px">
              ...
              <a href="${finalUrl}" style="display:inline-block;padding:12px 24px;background:#fff;color:#000;font-weight:600;border-radius:8px;text-decoration:none">
                Se connecter
              </a>
