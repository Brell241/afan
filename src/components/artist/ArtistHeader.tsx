        ...
        >
          ...
          <div className="mt-6 flex items-center gap-2">
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-4 py-2 rounded-full bg-white/10 hover:bg-white/20 border border-white/15 text-white/70 hover:text-white text-xs font-medium backdrop-blur transition-all"
            >
              <PlusCircle size={13} />
              Proposer un album
            </button>
