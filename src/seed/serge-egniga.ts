...
const SERGE_EGNIGA_DISCOGRAPHY = [
  {
    ...
    tracks: [
      ...
      { title: "Où va la vie", track_number: 5, youtube_url: 'https://www.youtube.com/watch?v=cR3KLRj_RyE' },
      { title: "Souvenirs", track_number: 6, youtube_url: 'https://www.youtube.com/watch?v=oBlw4RjpghM' },
      { title: "Evowa", track_number: 7, youtube_url: 'https://www.youtube.com/watch?v=qYdcVjiCUPM' },
      { title: "Tonda", track_number: 8, youtube_url: 'https://www.youtube.com/watch?v=U14Y1yE9FjY' },
      { title: "Itónda", track_number: 9, youtube_url: 'https://www.youtube.com/watch?v=1AgpJswhuuc' },
      { title: "Inongo Ayilé", track_number: 10, youtube_url: 'https://www.youtube.com/watch?v=QIl-rhBTCnA' },
      { title: "Noir d'eben", track_number: 11, youtube_url: 'https://www.youtube.com/watch?v=pZe9DFd6N_g' },
    ],
  },
];
