...
const SIMA_MBOULA_DISCOGRAPHY = [
  {
    ...
    tracks: [
      ...
      { title: "SIMA JUNIOR PELLY N", track_number: 3, youtube_url: 'https://www.youtube.com/watch?v=Qaq80LzzAP0' },
      ...
      { title: "ET SIMA JUNIOR _ Alene Essong", track_number: 7, youtube_url: 'https://www.youtube.com/watch?v=rr-SxD_IHKI' },
      ...
      { title: "Gabon Ndong Mboula Etouk Dzom", track_number: 14, youtube_url: 'https://www.youtube.com/watch?v=OT8KtLJNGsE' },
      { title: "Elone", track_number: 15, youtube_url: 'https://www.youtube.com/watch?v=_pSm3sfXUiQ' },
      { title: "Don_zer", track_number: 16, youtube_url: 'https://www.youtube.com/watch?v=l_85DHE6fmQ' },
      { title: "Niveau A tobe Ya Bloque", track_number: 17, youtube_url: 'https://www.youtube.com/watch?v=Wt42PSo90hE' },
      { title: "JOE L ' INDIEN 2009 - 2010 yep GABAO", track_number: 18, youtube_url: 'https://www.youtube.com/watch?v=fqJpi0NFAaA' },
      { title: "Deux mille collé", track_number: 19, youtube_url: 'https://www.youtube.com/watch?v=lU8ktX8ZahM' },
    ],
  },
];
