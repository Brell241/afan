...
const NDONG_MBOULA_DISCOGRAPHY = [
  {
    ...
    tracks: [
      ...
      { title: "L Oncle de Billie By Nze Présente Ses Excuses au Peuple Gabonais et à Mme Baba Ramatou", track_number: 9, youtube_url: 'https://www.youtube.com/watch?v=SZJ5iLv38vs' },
      { title: "Lolo fodja parle fort à letoile kribienne sur ndolé miondo fait sa force et zéro dédicace à la veuve", track_number: 10, youtube_url: 'https://www.youtube.com/watch?v=SI4OaE619c4' },
      { title: "UN MAFFIOSO TENTE D'ARNAQUER DES PERSONNALITÉS GABONAISES EN SE FAISANT PASSER POUR JONAS MOULENDA", track_number: 11, youtube_url: 'https://www.youtube.com/watch?v=3PEpvGJH2tw' },
      { title: "PIFFO est décidé sur AÏCHA KAMOISE attendez son retour", track_number: 12, youtube_url: 'https://www.youtube.com/watch?v=gbRS5IeJf4o' },
      { title: "SORTEZ OOH UN BAMILÉKÉ NOMMÉ CHEF CHEZ LES EKANGS A ETOUDI", track_number: 13, youtube_url: 'https://www.youtube.com/watch?v=PIFFS_59ncA' },
      { title: "Le Phénomenal NDONG MBOULA", track_number: 14, youtube_url: 'https://www.youtube.com/watch?v=4aeEHuS9vKo' },
      { title: "Le voisin est devenu muet 😂", track_number: 15, youtube_url: 'https://www.youtube.com/watch?v=TWukGUSC_0M' },
      { title: "Reportage", track_number: 16, youtube_url: 'https://www.youtube.com/watch?v=7zNPdsk0CII' },
      { title: "Culture fang beti Olik m'awu", track_number: 17, youtube_url: 'https://www.youtube.com/watch?v=V1Y7M5KFMjU' },
    ],
  },
  {
